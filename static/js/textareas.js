tinyMCE.init({
	...
	theme_advanced_buttons2 : " syntaxhl|,cut,copy,paste,pastetext,|,search,replace,|,bullist,numlist,|,outdent,indent,blockquote,|,undo,redo,|,link,unlink,anchor,image,cleanup", //,|,insertdate,inserttime,preview,|,forecolor,backcolor",
